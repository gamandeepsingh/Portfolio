    ...
    <div className="flex max-w-[1080px] min-h-[600px] flex-wrap justify-center items-center max-md:flex-col-reverse max-md:mt-28">
      ...
      <div className="w-2/3 max-md:w-5/6 text-white min-md:mr-10 mt-16 max-md:mb-32">
        ...
        <p className="max-md:text-center max-md:font-bold">
          Hello! I'm <span className="text-[#fc0099] font-bold italic">Gamandeep Singh</span>, a passionate software developer specializing in building scalable and efficient web applications. Currently pursuing a B.Tech in Computer Science and Information Technology, I am also working as an <span className="text-[#fc0099] font-bold italic"> SDE Intern</span> at <a href="https://www.elanine.com/" target="_blank" className="text-[#fc0099] font-bold italic">Elanine Creatives</a>, where I contribute to SaaS projects using technologies like React, Node.js, MongoDB, and AWS. With a strong foundation in problem-solving and a drive for innovation, I aim to create impactful solutions that make a difference. Let's connect and build something amazing together!
        </p>
      </div>
      {/* right */}
